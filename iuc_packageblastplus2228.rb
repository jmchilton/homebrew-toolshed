...
class IucPackageblastplus2228 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/iuc/package_blast_plus_2_2_28
  # Tool Shed Readme:
  #    
  ...
  if OS.mac? and Hardware.is_64_bit? and !build.without?("architecture")
    url "ftp://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/2.2.28/ncbi-blast-2.2.28+-universal-macosx.tar.gz"
    sha1 ""
    ...
    url "ftp://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/2.2.28/ncbi-blast-2.2.28+-x64-linux.tar.gz"
    sha1 ""
  elsif OS.linux? and Hardware.is_32_bit? and !build.without?("architecture")
    url "ftp://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/2.2.28/ncbi-blast-2.2.28+-ia32-linux.tar.gz"
    sha1 ""
