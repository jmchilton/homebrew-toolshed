...
class JjohnsonPackageshear027 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/jjohnson/package_shear_0_2_7
  # Tool Shed Readme:
  #    
  ...
  url "http://vk.cs.umn.edu/SHEAR/downloads/shear-v0.2.7-compiled.tar.gz"
  sha1 ""
