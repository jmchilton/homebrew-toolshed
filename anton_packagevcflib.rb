...
class AntonPackagevcflib < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/anton/package_vcflib
  # Tool Shed Readme:
  #    
  ...
  if OS.linux? and Hardware.is_64_bit? and !build.without?("architecture")
    url "http://depot.galaxyproject.org/package/linux/x86_64/vcflib/vcflib-586c5ae5d57a38dae6b32ea831fb1f7cfa14c9bd.tar.gz"
    sha1 ""
  else
