...
class BiopythonPackagebiopython162 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/biopython/package_biopython_1_62
  # Tool Shed Readme:
  #    
  ...
  url "https://pypi.python.org/packages/source/b/biopython/biopython-1.62.tar.gz"
  sha1 ""
