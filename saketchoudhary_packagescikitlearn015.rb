...
class SaketchoudharyPackagescikitlearn015 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/saket-choudhary/package_scikit_learn_0_15
  # Tool Shed Readme:
  #    
  ...
  depends_on "jmchilton/toolshed/saketchoudhary_packageblas350"
