...
class IucPackagerdkit201303 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/iuc/package_rdkit_2013_03
  # Tool Shed Readme:
  #    Compiling rdkit requires cmake, python headers, sqlite3, flex and bison.
  
  option "without-architecture", "Build without allowing architecture information (to force source install when binaries are available)."
  
  url "http://rdkit.googlecode.com/files/RDKit_2013_03_2.tgz"
  sha1 ""
