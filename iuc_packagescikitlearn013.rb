...
class IucPackagescikitlearn013 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/iuc/package_scikit_learn_0_13
  # Tool Shed Readme:
  #    
  ...
  url "https://pypi.python.org/packages/source/s/scikit-learn/scikit-learn-0.13.1.tar.gz"
  sha1 ""
