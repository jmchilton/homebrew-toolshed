...
class LparsonsPackagerseqc239 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/lparsons/package_rseqc_2_3_9
  # Tool Shed Readme:
  #    
  ...
  url "http://sourceforge.net/projects/rseqc/files/RSeQC-2.3.9.tar.gz"
  sha1 ""
