...
class AntonPackagevcflib8a5602bf07 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/anton/package_vcflib_8a5602bf07
  # Tool Shed Readme:
  #    
  ...
  if OS.linux? and Hardware.is_64_bit? and !build.without?("architecture")
    url "http://depot.galaxyproject.org/package/linux/x86_64/vcflib/vcflib-8a5602bf07-Linux-x86_64.tgz"
    sha1 ""
  else
