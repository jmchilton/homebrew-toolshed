...
class JjohnsonPackageshear029 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/jjohnson/package_shear_0_2_9
  # Tool Shed Readme:
  #    
  ...
  url "http://vk.cs.umn.edu/SHEAR/downloads/shear-v0.2.9-compiled.tar.gz"
  sha1 ""
