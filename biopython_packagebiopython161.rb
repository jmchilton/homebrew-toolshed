...
class BiopythonPackagebiopython161 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/biopython/package_biopython_1_61
  # Tool Shed Readme:
  #    
  ...
  url "https://pypi.python.org/packages/source/b/biopython/biopython-1.61.tar.gz"
  sha1 ""
