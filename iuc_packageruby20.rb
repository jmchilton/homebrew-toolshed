...
class IucPackageruby20 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/iuc/package_ruby_2_0
  # Tool Shed Readme:
  #    
  ...
  url "http://cache.ruby-lang.org/pub/ruby/2.0/ruby-2.0.0-p353.tar.gz"
  sha1 ""
