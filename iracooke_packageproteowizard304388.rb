...
class IracookePackageproteowizard304388 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/iracooke/package_proteowizard_3_0_4388
  # Tool Shed Readme:
  #    
  ...
  def install
    ...
    onoe("Unhandled tool shed action [download_binary] encountered.")
    onoe("Unhandled tool shed action [download_binary] encountered.")
    environment([{'action'=> 'prepend', 'variable'=> 'PATH', 'value'=> '$KEG_ROOT'},{'action'=> 'set', 'variable'=> 'PROTK_PWIZ_ROOT', 'value'=> '$KEG_ROOT'}])
  end
