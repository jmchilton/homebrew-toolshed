...
class DevteamPackager2110 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/devteam/package_r_2_11_0
  # Tool Shed Readme:
  #    
  ...
  if OS.mac? and Hardware.is_64_bit? and !build.without?("architecture")
    url "http://depot.galaxyproject.org/package/darwin/x86_64/R/R-2.11.0-Darwin-x86_64.tgz"
    sha1 ""
  elsif OS.linux? and Hardware.is_64_bit? and !build.without?("architecture")
    url "http://depot.galaxyproject.org/package/linux/x86_64/R/R-2.11.0-Linux-x86_64.tgz"
    sha1 ""
  else
    url "http://cran.rstudio.com/src/base/R-2/R-2.11.0.tar.gz"
    sha1 ""
  end
