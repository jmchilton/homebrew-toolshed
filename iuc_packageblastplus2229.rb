...
class IucPackageblastplus2229 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/iuc/package_blast_plus_2_2_29
  # Tool Shed Readme:
  #    
  ...
  if OS.mac? and Hardware.is_64_bit? and !build.without?("architecture")
    ...
    url "ftp://ftp.ncbi.nlm.nih.gov/blast/executables/blast+/2.2.29/ncbi-blast-2.2.29+-ia32-linux.tar.gz"
    sha1 ""
