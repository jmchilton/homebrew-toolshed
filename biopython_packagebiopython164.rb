...
class BiopythonPackagebiopython164 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/biopython/package_biopython_1_64
  # Tool Shed Readme:
  #    
  ...
  url "https://pypi.python.org/packages/source/b/biopython/biopython-1.64.tar.gz"
  sha1 ""
