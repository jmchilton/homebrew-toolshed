...
class BorisPackagefreetype252 < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/boris/package_freetype_2_5_2
  # Tool Shed Readme:
  #    
  #            
  ...
  def install
    ...
    system "export LDFLAGS=\"-Wl,-rpath,$PNG_LIB_PATH\" && ./configure --prefix=#{prefix}" 
    system "make install"
