...
class GeertvandeweyerPackageperlthreadingperlModuleThreadsShared < Formula
  version "1.0"
  # Recipe auto-generate from repository https://toolshed.g2.bx.psu.edu/geert-vandeweyer/package_perl_threading
  # Tool Shed Readme:
  #    This package install threads::shared CPAN package for Perl.
  
  option "without-architecture", "Build without allowing architecture information (to force source install when binaries are available)."
  
  url "http://search.cpan.org/CPAN/authors/id/J/JD/JDHEDDEN/threads-shared-1.46.tar.gz"
  sha1 ""
